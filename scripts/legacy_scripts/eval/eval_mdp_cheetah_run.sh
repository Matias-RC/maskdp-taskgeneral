#!/bin/bash
#SBATCH --job-name=maskdp_eval_cheetah_run       # Job name
...
pwd
echo "Evaluating cheetah_run on goal_reaching..."
...
python eval_goal_novideo.py \
    ...
    task=cheetah_run \
    snapshot_base_dir=/home/bibarel/workspace/maskdp_models/output/2025.10.16/013246_mdp/snapshot \
