#!/bin/bash
#SBATCH --job-name=maskdp_eval_jaco       # Job name
...
pwd
echo "Evaluating jaco_reach on goal_reaching..."
...
python eval_goal.py \
    ...
    goal_buffer_dir=/home/matias_rodriguez/maskdp-taskgeneral/maskdp_data/maskdp_train/ \
    snapshot_ts=400000 \
    project=eval-single-goal \
    replan=false \
    use_wandb=True \
    +exp_name=eval_jaco_reach