#!/bin/bash
#SBATCH --job-name=exorl_eval_quadruped_run      # Job name
...
pwd
echo "Evaluating ExORL quadruped_run on goal_reaching..."
...
python eval_goal_novideo.py \
    ...
    task=quadruped_run \
    snapshot_base_dir=/home/bibarel/workspace/exorl_models/output/2025.10.18/024401_mdp/snapshot \
