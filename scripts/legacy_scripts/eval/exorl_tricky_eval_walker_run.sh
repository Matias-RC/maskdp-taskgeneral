#!/bin/bash
#SBATCH --job-name=tricky_eval_walker_run       # Job name
...
pwd
echo "Evaluating finetuned walker_run on goal_reaching..."
...
python exorl_eval_goal.py \
    ...
    task=walker_run \
    algorithm=icm \
    snapshot_base_dir=/home/bibarel/workspace/exorl_models/output/2025.10.28/132440_mdp/finetunes \
