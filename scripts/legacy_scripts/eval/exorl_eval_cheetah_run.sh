#!/bin/bash
#SBATCH --job-name=exorl_eval_cheetah_run       # Job name
...
pwd
echo "Evaluating ExORL cheetah_run on goal_reaching..."
...
python eval_goal_novideo.py \
    ...
    task=cheetah_run \
    snapshot_base_dir=/home/bibarel/workspace/exorl_models/output/2025.10.18/024352_mdp/snapshot \
