#!/bin/bash
#SBATCH --job-name=exorl_eval_walker_run_disagreement       # Job name
...
python exorl_eval_goal.py \
    ...
    snapshot_base_dir=/home/bibarel/workspace/exorl_models/output/2025.10.23/033239_mdp/snapshot \
